in betty style write code for int handle_builtin(char **args)
include shell.h

in betty style write code for void free_args(char **args); 
include shell.h

in betty style write code for char *get_command_path(char *command);
include shell.h

in betty style write code for void environment_init(char **env);
include shell.h

in betty style write code for int set_env_var(char *name, char *value);
include shell.h

in betty style write code for int unset_env_var(char *name);
include shell.h

in betty style write code for int _atoi(char *str);
include shell.h
