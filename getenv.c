 ...
 *  Return: 1 on delete, else return 0 * @var: string environment varible property
 */
int _unset_enviro(info_t *info, char *var)
{
 ...
 *  Return: 0
 */
int _set_enviro(info_t *info, char *var, char *value)
{
	char *buf = NULL;
	list_t *node;
	char *p;
